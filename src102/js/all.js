...
function getUrlOrderId(){
    var id =  GetQueryString('biz_order_id');
    if(id){
        return id;
    }
    return false;
...
function isOrderNull() {
    ...
    if (_host == "buyertrade.taobao.com" || _host == "trade.taobao.com") {
        mmsg = taobaoElement();
...
function Panliinit(){
    ...
    myScript.src="https://browser-extensions.github.io/PanCrawl/src/libs/panli.js";
