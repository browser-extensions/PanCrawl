...
- 修复 淘宝 订单状态为退款时 （新版本模板页），信息抓取不准确


> yao.95095.com ，淘宝经常跳到 登陆页 ，
> 原因是 订单中有 `95095 的药品` 的订单号 => 
> 淘宝自身的原因 和 tmtrade.yao.95095.com 域名 登陆状态保存不了
> 待淘宝修复吧


- 已经跑完账号
  + 蝴蝶花花2009，番丽网络panli0014，panli0012， 蓝莓静静，番丽网咯panli0015


> 1.0.2

 - 优化天猫页面数据信息的验证
 - 根据淘宝 阶段性 不同模板渲染机制，合理错误处理优化
 - 对于 1688 的订单 信息获取， 如果当日 淘宝选择 新技术视图渲染模式，
   1688的订单信息将无法获取，目前可以忽略，到第二天淘宝会回滚新技术，此时就可以抓取 1688的了
 - 由于今日 淘宝 未投放 新技术的数据模板，所以也就暂停 1688 订单信息的另类抓取方案（没法开发测试）
 - 今日可以正常抓取 1688 订单信息
 - 今日已经成功 测试 跑完 3个 账号 （番丽网络panli0014，番丽网咯panli0015，蓝莓静静）
...
> 由于下一大版本改动过大，还没检验完成，所以该版本为周末紧急修复过渡板，以修复无法正常运行
